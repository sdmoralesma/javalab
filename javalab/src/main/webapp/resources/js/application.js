 ...
 * Module
 */
angular.module('labApp', ['blockUI', 'treeControl', "angucomplete-alt"])

    .factory('MiddlewareClient', function ($http) {
    ...
    .controller("mainCtrl", function ($scope, MiddlewareClient, blockUI) {
        $scope.libsModel = model;
        $scope.treeModelMap = new TreeModel().parse(model.treedata);
